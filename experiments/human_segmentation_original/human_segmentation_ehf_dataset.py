    ...
    def __init__(self, root_dir, train, k_eig=128, use_cache=True, op_cache_dir=None):
        ...
        if use_cache:
            ...
            if os.path.exists(load_cache):
                ...
                self.verts_list, self.faces_list, self.frames_list, self.massvec_list, self.L_list, self.evals_list, self.evecs_list, self.gradX_list, self.gradY_list = torch.load( load_cache)
                return
        ...
        if use_cache:
            ...
            torch.save((self.verts_list, self.faces_list, self.frames_list, self.massvec_list, self.L_list, self.evals_list, self.evecs_list, self.gradX_list, self.gradY_list), load_cache)
